      ...
      <div>
        <div className="product-details">
          <div className="produt-main-image">
            ...
            <img classname = "product-big-image" alt={product.fields.name} src={product.fields.imgurl1} />
          </div>
          <div className="product-name-price">
            ...
            <div>
              ...
              <h3 className= "product-description">{product.fields.description}</h3>
            </div>
            <div>
              <h1 className = "product-category-text"> Category: {product.fields.category} </h1>
            </div>
          </div>
        </div>
